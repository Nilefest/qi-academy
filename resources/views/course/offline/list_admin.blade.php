...
@section('templates')
    <template id="tpl_course_item">
        <tr class="course_item info" data-courseId="-1">
            ...
            <td class="days"><input min="1" type="number" class="text course_period" placeholder="1" value="">
            </td>
                ...
                <tbody>
                    @foreach ($courses_offline_list as $course_one)
                        <tr class="course_item info" data-courseId="{{ $course_one['id'] }}">
                            ...
                            <td class="days"><input min="1" type="number" class="text course_period"
                                    placeholder="1" value="{{ $course_one['period'] }}"></td>
